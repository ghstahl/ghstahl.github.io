...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_riot_observable__ = __webpack_require__(44);
...
(function webpackUniversalModuleDefinition(root, factory) {
  if (( false ? 'undefined' : _typeof2(exports)) === 'object' && ( false ? 'undefined' : _typeof2(module)) === 'object') module.exports = factory(__webpack_require__(0), __webpack_require__(5), __webpack_require__(6), __webpack_require__(8));else if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(5), __webpack_require__(6), __webpack_require__(8)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
...
})(undefined, function (__WEBPACK_EXTERNAL_MODULE_12__, __WEBPACK_EXTERNAL_MODULE_18__, __WEBPACK_EXTERNAL_MODULE_19__, __WEBPACK_EXTERNAL_MODULE_21__) {
  return (/******/function (modules) {
      ...
      var DynamicJsCssLoaderStore = function () {
        ...
        DynamicJsCssLoaderStore.prototype._safeLoadExternal = function _safeLoadExternal(component) {
          ...
          if (addedCompoment == null) {
            ...
            riot.control.trigger(Constants.WELLKNOWN_EVENTS.out.loadExternalJsCssAck, { state: true, component: component });
          } else {
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      var _routeStore = __webpack_require__(1);
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      var _progressStore = __webpack_require__(4);
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      var _riotcontrolStore = __webpack_require__(5);
      ...
      */
      ...
      var RCSWKE = _riotcontrolStore2.default.getConstants().WELLKNOWN_EVENTS;
      ...
      var PluginRegistrationStore = function () {
        ...
        PluginRegistrationStore.prototype._unregisterPlugin = function _unregisterPlugin(registration) {
          ...
          if (foundRegistration === null) {
            ...
            // 2. Remove the stores.
            for (var _i3 = 0; _i3 < foundRegistration.stores.length; _i3++) {
              riot.control.trigger(Constants.WELLKNOWN_EVENTS.out.riotContolRemoveStore, foundRegistration.stores[_i3].name);
            }
        ...
        PluginRegistrationStore.prototype._registerPlugin = function _registerPlugin(registration) {
          ...
          if (foundRegistration === null) {
            ...
            for (var _i4 = 0; _i4 < registration.postLoadEvents.length; _i4++) {
              riot.control.trigger(registration.postLoadEvents[_i4].event, registration.postLoadEvents[_i4].data);
            }
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      var CLSWKE = _componentLoaderStore2.default.getConstants().WELLKNOWN_EVENTS;
      var RSWKE = _routeStore2.default.getConstants().WELLKNOWN_EVENTS;
      ...
      var StartupStore = function () {
        ...
        StartupStore.prototype.bindEvents = function bindEvents() {
          ...
          if (this._bound === false) {
            ...
            // ------------------------------------------------------------
            this.on(Constants.WELLKNOWN_EVENTS.in.allComponentsLoadComplete, this._onAllComponentsLoadComplete);
            this._bound = !this._bound;
          }
        };
        ...
        StartupStore.prototype.unbindEvents = function unbindEvents() {
          ...
          if (this._bound === true) {
            ...
            // ------------------------------------------------------------
            this.off(Constants.WELLKNOWN_EVENTS.in.allComponentsLoadComplete, this._onAllComponentsLoadComplete);
            this._bound = !this._bound;
          }
        };
        ...
        StartupStore.prototype._onAllComponentsLoadComplete = function _onAllComponentsLoadComplete() {
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      var _fetchStore = __webpack_require__(7);
      ...
      var _localstorageStore = __webpack_require__(8);

      var _localstorageStore2 = _interopRequireDefault(_localstorageStore);

      var _errorStore = __webpack_require__(6);
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      var _riotRoute = __webpack_require__(18);

      var _riotRoute2 = _interopRequireDefault(_riotRoute);

      var _riotcontrol = __webpack_require__(19);

      var _riotcontrol2 = _interopRequireDefault(_riotcontrol);

      var _randomString = __webpack_require__(16);

      var _randomString2 = _interopRequireDefault(_randomString);

      var _riotRouteExtension = __webpack_require__(14);
      ...
      var _masterEventTable = __webpack_require__(15);
      ...
      var P7HostCore = function () {
        ...
        P7HostCore.prototype.Initialize = function Initialize() {
          ...
          this._componentLoaderStore = new _componentLoaderStore2.default();
          ...
          this._pluginRegistrationStore = new _pluginRegistrationStore2.default();
...
var routeContributionStore = new _routeContributionStore2.default();
