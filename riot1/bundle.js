...
var RiotControlStore = function () {
  ...
  RiotControlStore.prototype.bindEvents = function bindEvents() {
    ...
    this.on(riot.EVT.riotControlStore.in.riotContolAddStore, function (name, store) {
    ...
    this.on(riot.EVT.riotControlStore.in.riotContolRemoveStore, function (name) {
      console.log(riot.EVT.riotControlStore.in.riotContolRemoveStore, name);
      var store = _this._stores[name];
...
var RouteStore = function () {
  ...
  RouteStore.prototype.bindEvents = function bindEvents() {
    ...
    self.on(riot.EVT.contributeCatchAllRoute, function (r) {
    ...
    self.on(riot.EVT.routeStore.in.routeDispatch, function (route, force) {
    ...
    self.on(riot.EVT.routeStore.in.routeCatchallReset, function () {
      console.log(self.name, riot.EVT.routeStore.in.routeCatchallReset);
      riot.router.resetCatchAll();
    });

    self.on('riot-route-add-view', function (view) {
    ...
    self.on('riot-route-remove-view', function (view) {
      console.log(self.name, 'riot-route-remove-view', view);
      var s = self._viewsSet;
      s.delete(view);
      riot.routeState.views = Array.from(s);
    });
    self.on('riot-route-load-view', function (view) {
...
var ComponentLoaderStore = function () {
    ...
    ComponentLoaderStore.prototype._commitToState = function _commitToState() {
        ...
        self.state.components = new Map(componentsArray.map(function (i) {
            return [i.key, i];
        }));
    ...
    ComponentLoaderStore.prototype._findComponent = function _findComponent(key) {
        var self = this;
        for (var _iterator = self._components, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
            var _ref;
    ...
    ComponentLoaderStore.prototype._onLoadExternalJsCssAck = function _onLoadExternalJsCssAck(result) {
        var self = this;
    ...
    ComponentLoaderStore.prototype._onUnloadExternalJsCssAck = function _onUnloadExternalJsCssAck(result) {
        var self = this;
    ...
    ComponentLoaderStore.prototype._allLoadedCompleteCheck = function _allLoadedCompleteCheck() {
        var self = this;
        var result = true;
        for (var _iterator5 = self._components, _isArray5 = Array.isArray(_iterator5), _i5 = 0, _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator]();;) {
            var _ref5;
    ...
    ComponentLoaderStore.prototype._onComponentLoadComplete = function _onComponentLoadComplete(key) {
        var self = this;
    ...
    ComponentLoaderStore.prototype._onComponentUnloadComplete = function _onComponentUnloadComplete(key) {
        var self = this;
...
var DynamicJsCssLoaderStore = function () {
	...
	DynamicJsCssLoaderStore.prototype._safeLoadExternal = function _safeLoadExternal(component) {
		...
		if (addedCompoment == null) {
			...
			riot.control.trigger(riot.EVT.dynamicJsCssLoaderStore.out.loadExternalJsCssAck, { state: true, component: component });
		} else {
	...
	DynamicJsCssLoaderStore.prototype._bindEvents = function _bindEvents() {
...
var ErrorStore = function () {
  ...
  ErrorStore.prototype._bindEvents = function _bindEvents() {
    var self = this;
    self.on(riot.EVT.errorStore.in.errorCatchAll, function (error) {
...
function FetchStore() {
    ...
    self.onRiotTrigger = function (query, data) {
        if (query.query) {
    ...
    self.on(riot.EVT.fetchStore.in.fetch, function (input, init, trigger) {
...
if (true) module.exports = FetchStore;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
if (true) module.exports = LocalStorageStore;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var NextConfigStore = function () {
  ...
  NextConfigStore.prototype._bindEvents = function _bindEvents() {
    var self = this;
...
var PluginRegistrationStore = function () {
  function PluginRegistrationStore() {
...
if (true) module.exports = ProgressStore;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var StartupStore = function () {
  ...
  StartupStore.prototype._bindEvents = function _bindEvents() {
    var self = this;
    self._done = false;
    //------------------------------------------------------------
    self.on(riot.EVT.startupStore.in.start, function (nextTag) {
    ...
    //------------------------------------------------------------
    self.on(riot.EVT.startupStore.in.fetchConfig, function (path, ack) {
    ...
    //------------------------------------------------------------
    self.on(riot.EVT.startupStore.in.fetchConfigResult2, function (result, myTrigger) {
    ...
    //------------------------------------------------------------
    self.on(riot.EVT.startupStore.in.componentsAdded, function (ack) {
    ...
    self.onAllComponentsLoadComplete = function () {
    ...
    //------------------------------------------------------------
    self.on(riot.EVT.startupStore.in.allComponentsLoadComplete, self.onAllComponentsLoadComplete);
  };
...
riot.tag2('startup', '', '', '', function (opts) {
  ...
  self.on('mount', function () {
    ...
    riot.control.trigger('StartupStore:fetch-config', self.config, { evt: 'startup-tag-fetch-config-ack' });
  });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_riot_observable__ = __webpack_require__(58);
...
var _fetchStore = __webpack_require__(14);

var _fetchStore2 = _interopRequireDefault(_fetchStore);

var _itemstore = __webpack_require__(15);

var _itemstore2 = _interopRequireDefault(_itemstore);

var _sidebarStore = __webpack_require__(21);

var _sidebarStore2 = _interopRequireDefault(_sidebarStore);

var _nextConfigStore = __webpack_require__(17);
...
riot.control.addStore(new _progressStore2.default());

riot.control.addStore(new _localstorageStore2.default());

riot.control.addStore(new _RiotControlStore2.default());

riot.control.addStore(new _RouteStore2.default());

riot.control.addStore(new _errorStore2.default());

riot.control.addStore(new _routeContributionStore2.default());

riot.control.addStore(new _dynamicJscssLoaderStore2.default());

riot.control.addStore(new _pluginRegistrationStore2.default());

riot.control.addStore(new _componentLoaderStore2.default());

riot.control.addStore(new _startupStore2.default());

riot.control.addStore(new _RiotControlDispatcherStore2.default());

riot.control.addStore(new _fetchStore2.default());

riot.control.addStore(new _itemstore2.default());

riot.control.addStore(new _sidebarStore2.default());

riot.control.addStore(new _nextConfigStore2.default());
